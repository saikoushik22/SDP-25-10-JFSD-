...
const FacultyAssignment = lazy(() =>
  import("./Components/Forms/FacultyAssignment")
);
const StudentAssignment = lazy(() =>
  import("./Components/Forms/StudentAssignment")
);
    ...
    createRoutesFromElements(
      <Route path="/" element={<AppLayout />} errorElement={<ErrorElement />}>
        ...
        >
          ...
          {/* Role-Specific Assignment Routes */}
          <Route
            path="assignments"
            element={
              <Suspense fallback={<Loading />}>
                {/* Use Context or Role Checking */}
                <RoleBasedAssignment />
              </Suspense>
            }
          />
...
// Component for Role-Based Assignment Routing
