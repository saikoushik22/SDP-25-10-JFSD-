    ...
    <>
      {!user?._id ? (
        <main className="relative z-0 flex h-screen flex-col items-center justify-center bg-gradient-to-b from-slate-400 to-slate-300 text-slate-950 dark:from-slate-800 dark:to-slate-950 dark:text-slate-300">
          ...
          <CircleDesign />
          <section className="z-0 mb-4 flex flex-col items-center duration-200 gap-2 whitespace-normal text-3xl md:text-4xl lg:text-5xl xl:text-6xl">
  <FaUniversity />
  <h1 className="font-spectral font-semibold text-center text-slate-900 dark:text-slate-300">
